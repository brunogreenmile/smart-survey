# language: en
@SmartSurveyTest
Feature: To test validation of a smartSurvey organization
 The system must validate the organization field
  
  Background: creates dependences
 
    Given that description is "TEST002"
  ...
  Scenario: Verify organization
    Given the creation of a smartsurvey
    Then the message is "Organization is mandatory"
